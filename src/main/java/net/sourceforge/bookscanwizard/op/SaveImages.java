 ...
 * Saves the image.
 */
public class SaveImages extends Operation implements SaveOperation {
    private static final Logger logger = Logger.getLogger(SaveImages.class.getName());
    ...
    private void saveJ2000(String destFile, RenderedImage img, int dpi) throws IOException {
        try (FileOutputStream fos = new FileOutputStream(destFile+".jp2")) {
