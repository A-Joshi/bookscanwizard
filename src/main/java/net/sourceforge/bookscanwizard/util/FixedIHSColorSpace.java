 ...
 *
 * With patch:
 * http://java.net/jira/secure/attachment/43194/IHSColorSpace-patch.diff
 */
...
public final class FixedIHSColorSpace extends ColorSpaceJAI {
     ...
     */
    public static FixedIHSColorSpace getInstance() {
        synchronized(reference) {
            Object referent = reference.get();
            FixedIHSColorSpace cs;
            if (referent == null) {
                // First invocation or SoftReference has been cleared.
                reference = new SoftReference(cs = new FixedIHSColorSpace());
            } else {
                // SoftReference has not been cleared.
                cs = (FixedIHSColorSpace)referent;
            }
	...
	if (isByte) {
        ...
        int height = src.raster.getHeight();
        int width = src.raster.getWidth();
...
/******************************************************************************
 * The following are package methods copied from ColorSpaceJAI
 */
